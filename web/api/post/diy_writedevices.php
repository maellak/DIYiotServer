...
$app->post('/writedevice', function () use ($authenticateForRole, $diy_storage)  {
        global $app;
...
function diy_writedevice($payload,$storage){
    global $app;
    ...
    //$binfile= OAuth2\Request::createFromGlobals()->request["binfile"];
